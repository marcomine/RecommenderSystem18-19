...
class SLIM_BPR_Cython(SimilarityMatrixRecommender, Recommender, Incremental_Training_Early_Stopping):
    ...
    def fit(self, epochs=50, logFile=None,
            batch_size = 800, lambda_i = 1e-06, lambda_j = 1e-09, learning_rate = 0.1, topK = 200,
            sgd_mode='adagrad', gamma=0.9, beta_1=0.9, beta_2=0.94,
